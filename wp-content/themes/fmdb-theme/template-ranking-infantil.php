<?php
/**
 * Template Name: Ranking · Selección Infantil
 *
 * Assign to a page nested under "Ranking" with slug "infantil",
 * so it resolves at /ranking/infantil/.
 */
get_header();

$data = fmdb_get_ranking_data();

// Keep only the three infantil age categories on this page
$infantil_keys = [ 'infantil-menor', 'infantil-intermedia', 'infantil-mayor' ];
$data = array_intersect_key( $data, array_flip( $infantil_keys ) );

// Default tab from ?cat=, else 'infantil-menor'
...
<main class="fmdb-ranking">
    <header class="fmdb-ranking__hero">
        <div class="fmdb-ranking__hero-inner">
            ...
            <h1 class="fmdb-ranking__title">Ranking · Selección Infantil</h1>
            ...
            <section class="fmdb-ranking__cat<?php echo $cat_key === $active ? ' is-active' : ''; ?>"
                ...
                <?php if ( ! empty( $cat['totals'] ) ) : ?>
                    <div class="fmdb-ranking__combined">
                        ...
                        <?php fmdb_render_podium( $cat['totals'] ); ?>
                    </div>
                <?php endif; ?>
                ...
                <div class="fmdb-ranking__more">
                    <a class="fmdb-btn fmdb-btn--primary" href="<?php echo esc_url( home_url( '/ranking/infantil/tablas/?cat=' . $cat_key ) ); ?>">Ver tablas completas</a>
                </div>
            </section>
        <?php endforeach; ?>
    </div>
