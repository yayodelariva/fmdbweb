<?php
/**
 * Template Name: Ranking · Tablas
 *
 * Assign to a page from the WP editor (Page Attributes → Template).
 * Intended to be assigned to a "Tablas" page nested under "Ranking",
 * so it resolves at /ranking/tablas/.
 */
get_header();
...
// Tablas mirrors Mayor (Foam + Cloth) — infantil/juvenil tables live on their own sub-pages
...
<main class="fmdb-ranking">
    <header class="fmdb-ranking__hero">
        <div class="fmdb-ranking__hero-inner">
            ...
            <h1 class="fmdb-ranking__title">Tablas de Ranking</h1>
