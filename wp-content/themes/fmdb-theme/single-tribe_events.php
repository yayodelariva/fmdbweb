                ...
                <div class="fmdb-evento-single__meta-card">
                    ...
                    <div class="fmdb-evento-single__meta-item">
                        ...
                        <div>
                            ...
                            <span><?php echo $date_tbd ? 'Horario por determinarse' : date_i18n( 'g:i a', $start_ts ); ?></span>
                        </div>
                    </div>
                    ...
                    ?>
                        <div class="fmdb-evento-single__meta-item">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                            <div>
                                <strong>Horario por día</strong>
                                <ul class="fmdb-evento-single__day-schedule">
                                    <?php foreach ( $day_schedule as $day ) :
                                        $ds = ! empty( $day['start_time'] ) ? $day['start_time'] : '';
                                        $de = ! empty( $day['end_time'] )   ? $day['end_time']   : '';
                                        if ( ! $ds && ! $de ) continue;
                                        $dl = ! empty( $day['label'] ) ? $day['label'] : '';
                                        $dt = $ds . ( $de ? ' – ' . $de : '' );
                                    ?>
                                        <li class="fmdb-evento-single__day-row">
                                            <?php if ( $dl ) : ?>
                                                <span class="fmdb-evento-single__day-label"><?php echo esc_html( $dl ); ?></span>
                                            <?php endif; ?>
                                            <span class="fmdb-evento-single__day-time"><?php echo esc_html( $dt ); ?></span>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
